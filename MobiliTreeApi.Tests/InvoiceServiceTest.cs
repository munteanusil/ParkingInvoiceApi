...
namespace ParkingApi.Tests
{
    public class InvoiceServiceTest
    {
        ...
        public InvoiceServiceTest()
        {
            ...
            _sessionPricingService = new SessionPricingService(_parkingFacilityRepository);
        }
        ...
        [Fact]
        public void GivenWeekendSessionWithContract_WhenQueried_ShouldReturnCorrectInvoiceAmount()
        {
            // 15 decembrie 2018 => sambata
            var startDateTime = new DateTime(2018, 12, 15, 4, 0, 0);
            ...
            var result = GetSut().GetInvoices("pf001");
            var invoice = result.SingleOrDefault(i => i.CustomerId == "c001");

            Assert.NotNull(invoice);

            decimal expectedAmount = 2 * 0.8m;
